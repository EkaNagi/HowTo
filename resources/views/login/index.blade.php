  ...
  <div class="mt-1 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <form class="space-y-6" action="/login" method="post">
      ...
      <div>
        ...
        <div class="mt-2">
          <input id="email" name="email" type="email" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-teal-600 sm:text-sm sm:leading-6 @error('email') is-invalid @enderror" placeholder="name@example.com" autofocus required value="{{ old('email') }}">
        </div>
          @error('email')
            <div class="">
              {{ $message }}
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
      Belum join kita?
      <a href="/register" class="font-semibold leading-6 text-teal-600 hover:text-teal-500">Daftar cepet!</a>
      <br>
      Atau, 
